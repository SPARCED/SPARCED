...
class SparcedModel:
    ...
    def load_compilation_files(self, data_location: str | os.PathLike,
        ...
        Note:
            ...
            > a 'root' item indicating the location of the compilation input files subfolder
            > a 'files' item containing a dictionnary of file types and their names

        Arguments:
            data_location: The path towards the location of the model's data.
            compilation_config: A dictionnary structured as stated in the __Note__ section.

        Returns:
            A dictionnary structured as key: input file type / value: input file path.
        """
    ...
    def sanitize_name(self, name: str) -> str:
        ...
        Note:
            As Antimony cannot handle the dash ('-') character as a model name,
            any occurence of this character is replaced by an underscore ('_').

        Warning:
            This might result into the breakage of some further functionalities.

...
sys.path.insert(0, os.path.abspath('../../SPARCED/src/benchmarking'))
sys.path.insert(0, os.path.abspath('../../SPARCED/src/benchmarking/simulation'))
sys.path.insert(0, os.path.abspath('../../SPARCED/src/benchmarking/visualization'))
sys.path.insert(0, os.path.abspath('../../SPARCED/src/benchmarking/creation'))
sys.path.insert(0, os.path.abspath('../../SPARCED/src/benchmarking/sedml'))
